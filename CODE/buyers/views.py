...
def BuyerTotalAmountCheckOut(request):
    ...
    bank = ('0x4de10dA8B705e2578C269d72846fb51F17B02E43','0xc952D5898356f30972cbe8aF207B11D7bDa67Fd1','0x9c31701155c2dCec29a432669fd79332a853F32E', '0x9b3531536666763dB9F82B5e89c1EE73F613F968','0xfa8C25AFF6847aD6C10005C3b339F644359b1eFA')
...
def StartBlockChainTransaction(request):
    if request.method=='POST':
        ...
        #Transaction Data
        cardnumber = ''.join(random.choices('0123456789', k=16)) #request.POST.get('cardnumber')
        nameoncard = buyername #request.POST.get('nameoncard')
        cvv = '321' #request.POST.get('cvv')
        cardexpiry = '06/25' #request.POST.get('cardexpiry')
